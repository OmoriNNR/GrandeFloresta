...
2. Ao importar o repo, o Render detectará o `render.yaml` e criará:
...
5. A primeira subida leva alguns minutos. Quando terminar, acesse `https://<nome-do-servico>.onrender.com`.
